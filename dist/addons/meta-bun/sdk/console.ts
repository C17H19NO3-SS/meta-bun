...
export { ReplySource } from "../shared/types/enums";
export { ReplySource_Console, ReplySource_Chat } from "../shared/types/enums";
 ...
 */
export function RegConsoleCmd(command: string, callback: CommandCallback, flags?: string | null, description?: string | null): void {
 ...
 */
export function CheckCommandAccess(client: number, command: string, flags: string): boolean {
