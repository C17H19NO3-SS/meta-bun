...
export interface IAdminManager {
   ...
   */
  CreateAdmin(steamid: string, flags: string, immunity?: number, expiresAt?: number): void;
   ...
   */
  AddAdminGroup(groupName: string, flags: string, immunity?: number, inherit?: string): void;
   ...
   */
  LogAction(adminSteamId: string, adminName: string, targetSteamId: string, targetName: string, action: string): void;
}
