...
import type { ConVar, ClientCookie, SDKHookType } from "../shared/types/bridge";
import type { GameEvent } from "../shared/types/events";

export { Action, Plugin_Continue, Plugin_Changed, Plugin_Handled, Plugin_Stop } from "../shared/types/enums";
 ...
 */
export function TPrintToChat(client: number, key: string, ...args: unknown[]): void {
 ...
 */
export function CreateAdmin(steamid: string, flags: string, immunity: number = 0, expiresAt: number = 0): void {
 ...
 */
export function AddAdminGroup(groupName: string, flags: string, immunity: number = 0, inherit?: string): void {
 ...
 */
export function LogAdminAction(admin: number, target: number | null | undefined, actionMessage: string): void {
 ...
 */
export function CreateConVar(name: string, defaultValue: string, description?: string): ConVar {
 ...
 */
export function RegClientCookie(name: string, description: string): ClientCookie {
 ...
 */
export function HookEventPre(event: string, callback: (data: GameEvent) => number): void {
 ...
 */
export function SDKHook(client: number, hookType: SDKHookType, callback: (...args: unknown[]) => number): void {
 ...
 */
export function SDKUnhook(client: number, hookType: SDKHookType, callback: (...args: unknown[]) => number): void {
