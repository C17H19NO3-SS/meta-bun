...
export class Player extends EventEmitter implements IPlayer {
	...
	public GetMVPs(): number {
		return this._mvps;
	}
	public GetPlaytime(): number {
		const sessionSeconds = Math.floor(
			(Date.now() - this._sessionStartTime) / 1000,
		);
		return this._playtime + sessionSeconds;
	}
	public AddHeadshot(): void {
		this._headshots++;
		this._lastActiveTime = Date.now();
	}
	public AddDamage(val: number): void {
		this._damage += val;
		this._lastActiveTime = Date.now();
	}
	public AddMVP(): void {
	...
	// Admin Immunity
	public GetImmunity(): number {
		return this.adminManager.GetImmunity(this.steamId);
	}
	public CanTarget(target: Player): boolean {
	...
	public UpdateArmor(value: number): void {
		this._armor = value;
	}
	...
	public UpdateKills(value: number): void {
		this._kills = value;
	}
	public UpdateDeaths(value: number): void {
		this._deaths = value;
	}
	public UpdateAssists(value: number): void {
		this._assists = value;
	}
	...
	public GetObserverTarget(): number {
		return this._observerTarget;
	}
	public GetEntityFlags(): number {
	...
	public GetClip1(): number {
		return this._clip1;
	}
	public GetReserve1(): number {
