...
export interface IPlayer {
   ...
   */
  EmitSound(soundPath: string, volume?: number, channel?: number, pitch?: number): void;
...
export interface IPlayerManager {
   ...
   */
  CheckReservation(connectingSteamId: string, connectingFlags: string, maxClients?: number): { allowed: boolean; kickIndex?: number };
