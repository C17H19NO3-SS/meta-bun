...
async function fetchGlobalGeoIP() {
  console.log("[GeoIP Global] Fetching comprehensive worldwide GeoIP CSV data...");
  
  try {
    const response = await fetch("https://raw.githubusercontent.com/sapics/ip-location-db/master/dbip-country/dbip-country-ipv4.csv");
    ...
    const countryNames: Record<string, string> = {
      ...
      "FR": "France", "RU": "Russia", "CN": "China", "BR": "Brazil", "IN": "India",
      "JP": "Japan", "KR": "South Korea", "IT": "Italy", "ES": "Spain", "CA": "Canada",
      "AU": "Australia", "NL": "Netherlands", "PL": "Poland", "UA": "Ukraine", "RO": "Romania",
      "AZ": "Azerbaijan", "KZ": "Kazakhstan", "UZ": "Uzbekistan", "SE": "Sweden", "NO": "Norway"
    };
    ...
    console.log(`[GeoIP Global] Successfully saved ${geoData.length} worldwide ranges to ${dbPath}.`);
  } catch (error) {
